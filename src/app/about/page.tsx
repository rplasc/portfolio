  ...
  const timeline = [
    {
      ...
      date: '2025',
      description: 'Collaborted in a team that built a cross-platform file sync app using React Native, Flask, and Rclone.',
    ...
    },
    {
      ...
      icon: <FaComputer className='text-blue-400 text-x1' />
    }
  ];
